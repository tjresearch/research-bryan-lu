...
function_signature_tuples = ( # put finalrelations.txt here !!
    ('Not', 'truth', ['truth']),
    ('True', 'truth', ['truth']),
    ('IsLine', 'truth', ['line']),
    ('IsPoint', 'truth', ['point']),
    ...
    # NEW !
    #('Cevian', 'line', []), ??
    ('ABisector', 'line', ['triangle', 'point']),
    # ('PBisector', 'line', ['segment']),
    ('Median', 'line', ['triangle', 'point']),
    ('Altitude', 'line', ['triangle', 'point']),
    # FootOf
    ('Cyclic', 'truth', ['quad']),
    #('Reflection', ),
    ('Circumcircle', 'circle', ['triangle']),
    ('Incircle', 'circle,', ['triangle']),
    ('Circumcenter', 'point', ['triangle']),
    ('Incenter', 'point', ['triangle']),
    ('Orthocenter', 'point', ['triangle']),
    ('Centroid', 'point', ['triangle']),
    ('IsCircumcircle', 'truth', ['circle', 'triangle']),
    ('IsIncircle', 'truth', ['circle', 'triangle']),
    ('IsCircumcenter', 'truth', ['point', 'triangle']),
    ('IsIncenter', 'truth', ['point', 'triangle']),
    ('IsOrthocenter', 'truth', ['point', 'triangle']),
    ('IsCentroid', 'truth', ['point', 'triangle'])
)
